...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--path", help="path for the folder to save the processed files"
    )
    parser.add_argument(
    ...
    complete_data["train"].to_csv("data/train.csv")
    complete_data["test"].to_csv("data/test.csv")
    logging.debug(f"Train test data saved folder succesfully")
